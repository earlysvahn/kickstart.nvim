...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      end, { desc = '[C]hoose [S]cheme with preview' })

      local extensions = require('telescope').extensions

      vim.keymap.set('n', '<leader>sa', extensions.live_grep_args.live_grep_args, { desc = '[S]earch with [A]rgs (live grep)' })
      vim.keymap.set('n', '<leader>sn', extensions.noice.noice, { desc = '[S]earch [N]otifications (noice)' })
      ...
      end, { desc = '[Z] Search with Args' })

      vim.keymap.set('n', '<leader>freq', function()
