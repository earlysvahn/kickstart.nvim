...
-- Exports the keymaps to a text file with descriptions.
function M.export_keymaps_to_file()
...
-- Generates a README file with keymaps and commits the changes.
function M.generate_readme_with_keymaps()
  M.export_keymaps_to_file()
...
-- Create a custom user command to generate the README
vim.api.nvim_create_user_command('GenerateKeymapReadme', M.generate_readme_with_keymaps, {})
